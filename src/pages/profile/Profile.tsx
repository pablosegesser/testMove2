    ...
    <>
      <Header
        headerWithImage={
          <HeaderWithImage
            title="ASHLEY BENSON"
            subtitle="124K FOLLOWERS"
            buttonText={"EDIT PROFILE"}
          />
        }
        className="withIcon withImage"
        img="https://cdn.galleries.smcloud.net/t/galleries/gf-FsbC-uLmD-vqgG_ashley-benson-1920x1080-nocrop.jpg"
        logo={
          <Link to="/">
            <ArrowIcon />
          </Link>
      ...
      <CardWrap>
        {Array.from(Array(4)).map((v, i) => (
          <Card
            ...
            description={"fashion worldest event"}
            className={"small break top"}
            withButton={false}
            buttonText={""}
          />
        ))}
      ...
      {Array.from(Array(4)).map((v, i) => (
        <Cart
          ...
          price={"30.00"}
          imgUrl={
            "https://www.pruneshop.cl/media/catalog/product/cache/48a04200998cde1bd0724f004dc7dd57/P/I/PI02932CHAA1000_0_2.jpg"
          }
          description={"fashion worldest event"}
          className={""}
        />
