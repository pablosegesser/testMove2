...
import { TitleContainer, Title , FilterContainer, Button, FilterContent, Text, Wrap} from "../../styles/globalStyle";
...
const Shop: React.FunctionComponent<ShopProps> = () => {
    return (
        ...
        <Cart title={"REVOLVE"} price={'30.00'} imgUrl={'https://www.pruneshop.cl/media/catalog/product/cache/48a04200998cde1bd0724f004dc7dd57/P/I/PI02932CHAA1000_0_2.jpg'} description={'fashion worldest event'} className={"withIcon"} />
         ))} 
        </>
    )
};
